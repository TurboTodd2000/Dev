...
var dialogResults = [mailingChoice,componentChoice,lobChoice,modLanguageChoice,placeHolder,myFileName];
...
// 	with (myFile.metadataPreferences){

// 		author = userName;

// 		documentTitle = metadataValues[5];

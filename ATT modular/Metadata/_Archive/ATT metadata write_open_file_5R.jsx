...
var dialogResults = [mailingChoice,componentChoice,modLanguageChoice,placeHolder,orientationChoice,docName];

//these are for the standard metadata fields
var keywordResults = [mailingChoice,componentChoice,modLanguageChoice,orientationChoice];

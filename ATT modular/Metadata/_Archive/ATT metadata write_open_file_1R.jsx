...
//var myFixedPath = Folder.decode(myFile);
...
var dialogResults = [mailingChoice,componentChoice,lobChoice,modLanguageChoice,placeHolder,docName];
...
//due to how XMP works we need to write a file w/the info for our custom name space and then append it to the document

	var myXML = new XML("<x:xmpmeta xmlns:x=\"adobe:ns:meta/\"><rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"><rdf:Description xmlns:Kern_Agency=\"https://kernagency.com/\"></rdf:Description></rdf:RDF></x:xmpmeta>");
	...
	// insert nodes
	myDocXMP.setProperty(destNamespace,metadataFields[0],metadataValues[0]);
	myDocXMP.setProperty(destNamespace,metadataFields[1],metadataValues[1]);
	myDocXMP.setProperty(destNamespace,metadataFields[2],metadataValues[2]);
	myDocXMP.setProperty(destNamespace,metadataFields[3],metadataValues[3]);
	myDocXMP.setProperty(destNamespace,metadataFields[4],metadataValues[4]);
	myDocXMP.setProperty(destNamespace,metadataFields[5],metadataValues[5]);
...
// =========
	...
	var dropdown1_array = ["Select","Hero","RTB","Crescendos","Price Points","Address Panel","Offers","Address Panel","Bonus","Extras"]; 
...
// =========
	...
	var dropdown4_array = ["Landscape","Portrait"]; 
